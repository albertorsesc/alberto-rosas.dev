<footer class="border-t border-border dark:border-dark-border mt-24 py-12">
    <div class="mx-auto max-w-5xl px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
        <p class="text-sm text-muted dark:text-dark-muted">
            Alberto Rosas &mdash; Built with Laravel & too much coffee.
        </p>
        <div class="flex items-center gap-5">
            ...
            <a href="https://github.com/albertorsesc" target="_blank" rel="noopener noreferrer" class="text-muted hover:text-body dark:text-dark-muted dark:hover:text-dark-body transition-colors" aria-label="GitHub">
            ...
            <a href="https://x.com/bcryp7" target="_blank" rel="noopener noreferrer" class="text-muted hover:text-body dark:text-dark-muted dark:hover:text-dark-body transition-colors" aria-label="X (Twitter)">
